	...
	var Pivot = function () {
	  ...
	  _createClass(Pivot, [{
	    ...
	    value: function collapse(rowNum) {
	      var returnedData = (0, _progressiveDiscovery.collapse)(rowNum, this.currData);
	
	      this.collapsedRows[this.currData.table[rowNum].row] = returnedData.collapsed;
	    ...
	    value: function expand(rowNum) {
	      this.currData = (0, _progressiveDiscovery.expand)(rowNum, this.currData, this.collapsedRows[this.currData.table[rowNum].row]);
